        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailPassword = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    UserPasswordId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_Users_UserPasswordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_UserPasswordId",
                table: "Locations",
